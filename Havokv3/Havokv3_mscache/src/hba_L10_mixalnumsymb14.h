inline void reset_mixalnumsymb14_L10(char candidate[], unsigned int position[])
{
	...
	char charset8[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBTO*LHMGKCX@PI$#U-ZWFJ_Q+^V)%=&(";
	char charset9[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBTO*LHMGKCX@PI$#U-ZWFJ_Q+^V)%=&(";
...
void hba_L10_mixalnumsymb14(char candidate[], char permutations[], uint8_t *mscachehash, char u_username[], int sUlen)
{
	...
	reset_mixalnumsymb14_L10(candidate,position);//reset positions from password
