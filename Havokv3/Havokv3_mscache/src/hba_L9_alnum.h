inline void reset_alnum_L9(char candidate[], unsigned int position[])
{
...
void hba_L9_alnum(char candidate[], char permutations[], uint8_t *mscachehash, char u_username[], int sUlen)
{
	...
	reset_alnum_L9(candidate,position);//reset positions from password
