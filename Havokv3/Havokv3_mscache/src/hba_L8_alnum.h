inline void reset_alnum_L8(char candidate[], unsigned int position[])
{
...
void hba_L8_alnum(char candidate[], char permutations[], uint8_t *mscachehash, char u_username[], int sUlen)
{
	...
	reset_alnum_L8(candidate,position);//reset positions from password
