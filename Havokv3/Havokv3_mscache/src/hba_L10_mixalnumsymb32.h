inline void reset_mixalnumsymb32_L10(char candidate[], unsigned int position[])
{
	char charset0[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	char charset1[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	char charset2[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	char charset3[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	char charset4[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	char charset5[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	char charset6[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	char charset7[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	char charset8[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	char charset9[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	...
	for(int i=0;position[7]==666;i++)
		if(candidate[7]==charset7[i])
			position[7]=i;
	//set the charset position for ninth character of candidate
	for(int i=0;position[8]==666;i++)
		if(candidate[8]==charset8[i])
			position[8]=i;
	//set the charset position for tenth character of candidate
	for(int i=0;position[9]==666;i++)
		if(candidate[9]==charset9[i])
			position[9]=i;
}

void hba_L10_mixalnumsymb32(char candidate[], char permutations[], uint8_t *mscachehash, char u_username[], int sUlen)
{
	...
	char charset8[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	char charset9[] = "e1nsra326yt0d954o78lkgmihbpcxuwfzjvq!ESANRDYBT.O*LHMGKCX@PI$#U-ZWFJ_Q?+^V/,;)%~=`]&\\>:\"}[({|\'<";
	unsigned short int charcount=94;
	unsigned short int maxpos=charcount-1;
	unsigned int permutated=0;
	unsigned int position[]={666,666,666,666,666,666,666,666,666,666};
	
	//algorithm-specific initiations...
	uint8_t K[128];//was 16 - 128 should be big enough
	...
	position[0]=position[1]=position[2]=position[3]=position[4]=position[5]=position[6]=position[7]=position[8]=position[9]=666;//set positions to garbage
	reset_mixalnumsymb32_L10(candidate,position);//reset positions from password
...
for(;permutated<=2147000000 && position[9]<charcount;position[9]++)
{
	candidate[9]=charset9[position[9]];
	for(;permutated<=2147000000 && position[8]<charcount;position[8]++)
	{
		candidate[8]=charset8[position[8]];
							...
							for(;permutated<=2147000000 && position[2]<charcount;position[2]++)
							{
								...
								for(;permutated<=2147000000 && position[1]<charcount;position[1]++)
								{
									...
									for(;permutated<=2147000000 && position[0]<charcount;position[0]++)
									{
										...
										fast_MD4((unsigned char*)uni_pwd,20,K);
										memcpy(K+16, u_username, sUlen*2);
										fast_MD4((unsigned char*)K,(sUlen*2+16),(unsigned char*)K);
...
for(;permutated<=remainder && position[9]<charcount;position[9]++)
{
	candidate[9]=charset9[position[9]];
	for(;permutated<=remainder && position[8]<charcount;position[8]++)
	{
		candidate[8]=charset8[position[8]];
