inline void reset_mixalnumsymb32_L6(char candidate[], unsigned int position[])
{
...
void hba_L6_mixalnumsymb32(char candidate[], char permutations[], uint8_t *mscachehash, char u_username[], int sUlen)
{
	...
	unsigned int position[]={666,666,666,666,666,666};
	...
	position[0]=position[1]=position[2]=position[3]=position[4]=position[5]=666;//set positions to garbage
	reset_mixalnumsymb32_L6(candidate,position);//reset positions from password
						...
						for(;permutated<=2147000000 && position[2]<charcount;position[2]++)
						{
							...
							for(;permutated<=2147000000 && position[1]<charcount;position[1]++)
							{
								...
								for(;permutated<=2147000000 && position[0]<charcount;position[0]++)
								{
									...
									fast_MD4((unsigned char*)uni_pwd,12,K);
