inline void reset_mixalnumsymb32_L8(char candidate[], unsigned int position[])
{
...
void hba_L8_mixalnumsymb32(char candidate[], char permutations[], uint8_t *mscachehash, char u_username[], int sUlen)
{
	...
	reset_mixalnumsymb32_L8(candidate,position);//reset positions from password
