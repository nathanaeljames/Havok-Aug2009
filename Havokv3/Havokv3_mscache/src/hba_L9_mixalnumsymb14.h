inline void reset_mixalnumsymb14_L9(char candidate[], unsigned int position[])
{
...
void hba_L9_mixalnumsymb14(char candidate[], char permutations[], uint8_t *mscachehash, char u_username[], int sUlen)
{
	...
	reset_mixalnumsymb14_L9(candidate,position);//reset positions from password
