inline void reset_alnum_L5(char candidate[], unsigned int position[])
{
...
void hba_L5_alnum(char candidate[], char permutations[], uint8_t *mscachehash, char u_username[], int sUlen)
{
	...
	reset_alnum_L5(candidate,position);//reset positions from password
