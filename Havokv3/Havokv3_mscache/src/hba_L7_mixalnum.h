inline void reset_mixalnum_L7(char candidate[], unsigned int position[])
{
...
void hba_L7_mixalnum(char candidate[], char permutations[], uint8_t *mscachehash, char u_username[], int sUlen)
{
	...
	reset_mixalnum_L7(candidate,position);//reset positions from password
