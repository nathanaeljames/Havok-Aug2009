...
void usage()
{
       cout << " Usage: <start word> <permutations> <crack mode> <md4 hash>\n";
	   cout << "\n         crack modes:\n";
...
{
	cout << "\nHavokv3 md4 - a distributed md4 password cracker\n";
	...
	case 5:
		...
		{
		case 1:
			hba_L5_alnum(candidate,argv[2],md4hash);
			exit(0);
		case 2:
			hba_L5_mixalnum(candidate,argv[2],md4hash);
			exit(0);
		case 3:
			hba_L5_mixalnumsymb14(candidate,argv[2],md4hash);
			exit(0);
		case 4:
			hba_L5_mixalnumsymb32(candidate,argv[2],md4hash);
			exit(0);
		default:
			usage();
		}
	case 6:
		...
		{
		case 1:
			hba_L6_alnum(candidate,argv[2],md4hash);
			exit(0);
		case 2:
			hba_L6_mixalnum(candidate,argv[2],md4hash);
			exit(0);
		case 3:
			hba_L6_mixalnumsymb14(candidate,argv[2],md4hash);
			exit(0);
		case 4:
			hba_L6_mixalnumsymb32(candidate,argv[2],md4hash);
			exit(0);
		default:
			usage();
		}
	case 7:
		...
		{
		case 1:
			hba_L7_alnum(candidate,argv[2],md4hash);
			exit(0);
		case 2:
			hba_L7_mixalnum(candidate,argv[2],md4hash);
			exit(0);
		case 3:
			hba_L7_mixalnumsymb14(candidate,argv[2],md4hash);
			exit(0);
		case 4:
			hba_L7_mixalnumsymb32(candidate,argv[2],md4hash);
			exit(0);
		default:
			usage();
		}
	case 8:
		...
		{
		case 1:
			hba_L8_alnum(candidate,argv[2],md4hash);
			exit(0);
		case 2:
			hba_L8_mixalnum(candidate,argv[2],md4hash);
			exit(0);
		case 3:
			hba_L8_mixalnumsymb14(candidate,argv[2],md4hash);
			exit(0);
		case 4:
			hba_L8_mixalnumsymb32(candidate,argv[2],md4hash);
			exit(0);
		default:
			usage();
		}
	case 9:
		...
		{
		case 1:
			hba_L9_alnum(candidate,argv[2],md4hash);
			exit(0);
		case 2:
			hba_L9_mixalnum(candidate,argv[2],md4hash);
			exit(0);
		case 3:
			hba_L9_mixalnumsymb14(candidate,argv[2],md4hash);
			exit(0);
		case 4:
			hba_L9_mixalnumsymb32(candidate,argv[2],md4hash);
			exit(0);
		default:
			usage();
		}
	case 10:
		...
		{
		case 1:
			hba_L10_alnum(candidate,argv[2],md4hash);
			exit(0);
		case 2:
			hba_L10_mixalnum(candidate,argv[2],md4hash);
			exit(0);
		case 3:
			hba_L10_mixalnumsymb14(candidate,argv[2],md4hash);
			exit(0);
		case 4:
			hba_L10_mixalnumsymb32(candidate,argv[2],md4hash);
			exit(0);
		default:
			usage();
		}
