...
void hba_L9_mixalnumsymb32(char candidate[], char permutations[], uint8_t mscache_hash_array[25][16], char u_username_array[25][40], int sUsernameSize[],int numhashes)
{
